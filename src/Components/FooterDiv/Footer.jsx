...
const Footer = () => {
    return (
        <div className="footer pb-[4rem] pl-[2rem] pr-[4rem] mb-4 bg-blueColor rounded-[10px] gap-5 grid grid-rows-2 m-auto items-center justify-center">
            <div>
                <div className="lodoDiv">
                    <h1 className="logo text-[25px] text-white pb-[1.5rem] text-center">
                        <strong>Job</strong>
                        Search
                    </h1>
                </div>
